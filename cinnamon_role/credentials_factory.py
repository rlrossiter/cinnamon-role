...
def with_role_matching_credentials(cls):
    class _DecoratedClass(cls):
        ...
        def get_client_manager(cls, credential_type=None, roles=None,
            ...
            return super(_DecoratedClass, cls).get_client_manager(
                credential_type=credential_type, roles=roles, force_new=force_new)

    # In order to wrap cleanly, set the name of the decorated class back
    # to what it was before
    _DecoratedClass.__name__ = cls.__name__
